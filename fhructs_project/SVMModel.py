...
# Iterate through all files in the 'data' directory returns two matryxes X, & Y
def XYArrayMake():
    x, y = [], []
...
trainAccuracies, testAccuracies = getSVMScores(testSize)
...
for testSize in testSizes:
    # Call getSVMscores function with correct test size
    trainAcc, testAcc = getSVMScores(testSize)
