...
### Sprint Signature (5 points)

*   Your Sprint Signature accounts for all days worked
*   The *TODO* reminder and *Nocember* entries are removed from the final draft
*   The **TOTAL** line is present and agrees with your daily entries
    *   *Exception* you don't need a separate **TOTAL** line if you worked on the project for only one day
